...
use singularity::protocol::{Resource, FieldSet, CapabilityPayload};
...
fn test_object_plane_end_to_end() {
    ...
    let ns_id = "photos";
    let ctx_create_ns = create_context("resource.create", Resource::instance("__object_namespaces", ns_id));
    ...
    let ctx_write = create_context("object.write", Resource::instance(ns_id, object_key));
    ...
    // 5. Read Object
    let ctx_read = create_context("object.read", Resource::instance(ns_id, object_key));
    ...
    // 6. List Objects
    let ctx_list = create_context("object.list", Resource::instance(ns_id, ""));
    ...
    // 7. Delete Object
    let ctx_delete = create_context("object.delete", Resource::instance(ns_id, object_key));
